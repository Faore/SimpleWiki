		...
		<h1>{{ isset($page->title) ? $page->title : 'This page doesn\'t exist!' }}
			@if(isset($page->id))
				<span class="pull-right">
					...
					<a class="btn btn-danger btn-xs" href="/wiki/{{ $page->id }}/delete"><i class="glyphicon glyphicon-remove"></i></a>
					<a class="btn btn-warning btn-xs" href="/wiki/{{ $page->id }}/refresh"><i class="glyphicon glyphicon-refresh"></i></a>
					<a class="btn btn-primary btn-xs" href="/wiki/{{ $page->id }}/edit"><i class="glyphicon glyphicon-edit"></i> Edit</a>
				</span>
			@endif
		</h1>
		<hr>
